...
public class JsonResult<T> {
    ...
    private String msg;
    private T data;
    private Integer pagNums;//分页时使用，总页数
    ...
    public Integer getPagNums() {
        return pagNums;
    }

    public void setPagNums(Integer pagNums) {
    ...
    public static <T> JsonResult<T> success(T data,Integer pagNums) {
	    	JsonResult<T> ret = JsonResult.success();
	    	ret.setData(data);
            ret.setPagNums(pagNums);
        return ret;
    }
